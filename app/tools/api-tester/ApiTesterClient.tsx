...
export default function ApiTesterClient() {
  const seoData = toolSEOData["api-tester"];
  // Request State
  ...
  return (
    <div className="min-h-screen text-white flex flex-col font-sans selection:bg-cyan-500/30">
      <div className="flex-none p-4 sm:p-6 flex flex-col gap-6 max-w-[1600px] mx-auto w-full relative min-h-0">
        ...
        <ToolHeader 
          title="API Tester"
          description="Advanced (HTTP & HTTPS) Request Client. Test endpoints, inspect responses, and debug protocols seamlessly."
          icon={<Globe className="w-6 h-6 text-cyan-400" />}
          gradient={{ from: "cyan-400", to: "blue-500" }}
        />

        <div className="flex-none lg:h-[calc(100vh-74px)] lg:overflow-hidden flex flex-col lg:flex-row gap-6 max-w-[1600px] mx-auto w-full relative min-h-0">
