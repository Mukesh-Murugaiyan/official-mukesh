...
export const personalConfig: PersonalConfig = {
  ...
  finalQuestion: {
    ...
    line4: "But irukura oru life la una naa partner aga virumpuren di",
    line5: "Enodu kai kothu nadaka nii ready ah di ?",
    ...
    timeResponseMessage: "No pressure, Sathi. Nee un time eduthukko. Naan eppavum unakaga irukkiren. 🌙",
    contactAction: {
      type: "link",
